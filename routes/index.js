            ...
            "boards": [
                {
                    ...
                    "long_description": "There is no question that Twinsers and Quads have signi?cant advantages in side shore conditions. All well-known riders have switched to this set-up mainly because of the unbelievable turning of these boards. Kauli, who initiated the Twinser and Quad concept made these boards popular with his own unique style. He has put a lot of effort into the development of the JP range wanting a line of Quads that he can use around the world in all different conditions, not just in pure down-the-line conditions. This range shines in areas where Quads previously did not feel so much at home: Early planing, great speed and upwind performance.",
                    "sizes": [
                ...
                },
                {
                    ...
                    "long_description": "JP was the ?rst brand to introduce Freestyle Wave boards, the others followed. Then we brought the thruster setup for the smaller PRO Edition sizes and the others followed again. Some brands even also call their boards Freestyle Wave. If you want the original you don't need to look anywhere else.",
                    "sizes": [
                ...
                },
                {
                    ...
                    "long_description": "Steven van Broeckhoven and shaper Werner Gnigler have developed the three sizes, 90,100 and 106. Two of the sizes were already ?awless for today's powerful double moves and trick combos. These moves require fast and direct boards with explosive pop 'even a 2nd and 3rd time' and the 90 and 100 were up to that! Steven and Youp Schmit are more than happy with their feeling and performance. So we left them unchanged. Nevertheless, Steven had the intention to adapt the light air freestyle board not only to ful?ll the highest standards of modern freestyle in lighter winds but also to make it feel as radical as its smaller brothers.",
                    "sizes": [
